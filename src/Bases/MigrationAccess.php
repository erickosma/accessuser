...
abstract class MigrationAccess  extends Migration
{
    ...
    */
    ...
    {
        $connection = Config::getConfig('database.connection',app(),'sqlite');
 ...
 */
    ...
    {;
        if ($this->hasConnection()) {
            if(Schema::connection($this->getConnection())->hasTable($this->getTableName()) == false){
